                                ...
                                <table class="table table-striped">                          
                                    ...
                                    <?php foreach (Category::getSubCategoriesListAdmin($category['id']) as $subcategory): ?>
                                        <tr>
                                            ...
                                            <td><a href="/admin/category/update/<?php echo $subcategory['id'];?>" title="Edit">Редактировать</a></td>
                                            <td><a href="/admin/category/delete/<?php echo $subcategory['id'];?>" title="Delete">Удалить</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>
                            <?php endif; ?>
